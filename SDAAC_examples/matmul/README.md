...
matmul文件夹为用户展示了阻塞型矩阵乘接口以及非阻塞型矩阵乘接口的使用方式。
...
该文件夹内的示例主要涉及SDAA C编程模型所提供的矩阵乘接口，您可以通过SDAA C编程模型中的矩阵乘章节学习阻塞型矩阵乘接口和非阻塞型矩阵乘接口的使用方法：
- [SDAA C编程指南-矩阵乘](http://docs.tecorigin.com/release/sdaac/v1.16.0/#5f04zi8zjw9ryc)：介绍矩阵乘的的各个接口。
