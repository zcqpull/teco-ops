...
simple_examples文件夹为用户展示了SDAA C编程模型的入门示例，包含使用`printf`接口打印输出及SPMD编程范式示例。
...
该文件夹内的示例主要涉及SDAA C编程模型所提供的计算核心SPE同步接口，您可以通过SDAA C编程模型中的计算核心SPE同步章节学习同步接口的使用方法：
- [SDAA C编程指南-计算核心SPE同步](http://docs.tecorigin.com/release/sdaac/v1.16.0/#1xn7dno0vaoam7)：介绍计算核心SPE同步操作的各个接口。
...
```
bash run_customops.sh simple_examples
```
