...
DMA文件夹为用户展示了数据搬运中DMA数据搬运接口的使用方式。
...
该文件夹内的示例主要涉及DMA数据搬运接口，您可以通过SDAA C编程模型中的DMA数据搬运章节学习接口的使用方法：
- [SDAA C编程指南-DMA数据搬运](http://docs.tecorigin.com/release/sdaac/v1.16.0/#2xis9q8khqb64g)：介绍DMA数据搬运的各个接口。
