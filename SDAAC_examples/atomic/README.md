...
该文件夹内的示例主要涉及原子操作接口，您可以通过SDAA C编程模型中的原子操作章节学习接口的使用方法：
- [SDAA C编程指南-原子操作](http://docs.tecorigin.com/release/sdaac/v1.16.0/#2gfdvam2o7024i)：介绍原子操作的各个接口。
