...
simd文件夹为用户展示了SDAA C编程模型所提的各个向量接口的使用方式。
...
该文件夹内的示例主要涉及SDAA C编程模型所提供的向量接口，您可以通过SDAA C编程模型中的向量操作章节学习向量接口的使用方法：
- [SDAA C编程指南-向量操作](http://docs.tecorigin.com/release/sdaac/v1.16.0/#5c1rtwfrl0hmth)：介绍向量操作的各个接口。
