...
broadcast文件夹为用户展示了数据搬运中广播接口的使用方式。
...
该文件夹内的示例主要涉及广播接口，您可以通过SDAA C编程模型中的广播操作章节学习接口的使用方法：
- [SDAA C编程指南-Broadcast数据搬运](http://docs.tecorigin.com/release/sdaac/v1.16.0/#3ky406be8vfq9u)：介绍广播操作的各个接口。
...
```
bash run_customops.sh broadcast
```
