...
math_funcs文件夹为用户展示了数学函数接口的使用方式。
...
该文件夹内的示例主要涉及SDAA C编程模型所提供的数学函数接口，您可以通过SDAA C编程模型中的数学函数章节学习各个接口的使用方法：
- [SDAA C编程指南-数学函数](http://docs.tecorigin.com/release/sdaac/v1.16.0/#27zhfa0ardwslj)：介绍数学函数的的各个接口。
...
```
bash run_customops.sh math_funcs
```
